...
namespace KaosesTweaks.Common
{
    class Kaoses
    {
        ...
        public static bool IsLord(Hero hero)
        {
            ...
            return (hero.CharacterObject.Occupation == Occupation.Mercenary || hero.CharacterObject.Occupation == Occupation.Lord || hero.CharacterObject.Occupation == Occupation.GangLeader) && !hero.IsHumanPlayerCharacter;
        ...
        public static bool IsPlayerLord(Hero hero)
        {
            ...
            return (hero.CharacterObject.Occupation == Occupation.Mercenary || hero.CharacterObject.Occupation == Occupation.Lord || hero.CharacterObject.Occupation == Occupation.GangLeader) && !hero.IsHumanPlayerCharacter && IsPlayerClan(hero);
        }
