...
{
    class PregnancyBehavior : PregnancyCampaignBehavior
    {
        ...
        {
            PregnancyBehavior.Pregnancy pregnancy = _heroPregnancies.Find((PregnancyBehavior.Pregnancy x) => x.Mother == hero);
            if (pregnancy == null)
            {
        ...
        private void CheckOffspringsToDeliver(PregnancyBehavior.Pregnancy pregnancy)
        {
        ...
        {
            _heroPregnancies.Add(new PregnancyBehavior.Pregnancy(mother, mother.Spouse, CampaignTime.DaysFromNow(Campaign.Current.Models.PregnancyModel.PregnancyDurationInDays)));
        }
        ...
        {
            dataStore.SyncData<List<PregnancyBehavior.Pregnancy>>("_heroPregnancies", ref _heroPregnancies);
        }

        // Token: 0x04001007 RID: 4103
        private List<PregnancyBehavior.Pregnancy> _heroPregnancies = new List<PregnancyBehavior.Pregnancy>();
        ...
        internal class Pregnancy
        {
            ...
            {
                ((PregnancyBehavior.Pregnancy)o).AutoGeneratedInstanceCollectObjects(collectedObjects);
            }
            ...
            {
                return ((PregnancyBehavior.Pregnancy)o).Mother;
            }
            ...
            {
                return ((PregnancyBehavior.Pregnancy)o).Father;
            }
            ...
            {
                return ((PregnancyBehavior.Pregnancy)o).DueDate;
            }
