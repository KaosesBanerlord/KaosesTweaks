    ...
    class ArmyManagementCalculationModel : DefaultArmyManagementCalculationModel
    {
        ...
        private void KaosesCalculateCohesionChangeInternal(Army army, bool IsClanOnly, ref ExplainedNumber cohesionChange)
        {
            ...
            if (Factory.Settings.armyCohesionMultipliers)
            {
                ...
                if (Factory.Settings.armyDisableCohesionLossClanOnlyParties && armyIsClanOnly)
                {
                    starvingCohesion = 0;
                    lowMoraleCohesion = 0;
                    lowHealthyTroops = 0;
                }
                else if (Factory.Settings.armyApplyMultiplerToClanOnlyParties && armyIsClanOnly)
                {
                    if (Factory.Settings.ArmyDebug)
                    {
                    ...
                    starvingCohesion *= Factory.Settings.armyCohesionLossMultiplier;
                    lowMoraleCohesion *= Factory.Settings.armyCohesionLossMultiplier;
                    lowHealthyTroops *= Factory.Settings.armyCohesionLossMultiplier;
                }
