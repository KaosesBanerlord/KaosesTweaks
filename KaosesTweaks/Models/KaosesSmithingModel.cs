...
namespace KaosesTweaks.Models
{
    public class KaosesSmithingModel : DefaultSmithingModel
    {
        ...
        {
            IM.MessageDebug("Model GetSkillXpForRefining :");
        ...
        {
            IM.MessageDebug("Model GetSkillXpForSmelting :");
        ...
        {
            IM.MessageDebug("Model GetSkillXpForSmithing :");
        ...
        {
            IM.MessageDebug("Model GetEnergyCostForRefining :");
            int num = 6;
        ...
        {
            IM.MessageDebug("Model GetEnergyCostForSmithing :");
        ...
        {
            IM.MessageDebug("Model GetEnergyCostForSmelting :");
            int num = 10;
            if (Statics._settings.SmithingEnergyDisable)
            {
