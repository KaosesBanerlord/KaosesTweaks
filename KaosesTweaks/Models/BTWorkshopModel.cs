...
namespace KaosesTweaks.Models
{
    class BTWorkshopModel : DefaultWorkshopModel
    {
        ...
        {
            if (KTSettings.Instance is { } settings && settings.MaxWorkshopCountTweakEnabled)
        ...
        {
            if (KTSettings.Instance is { } settings && settings.WorkshopBuyingCostTweakEnabled && workshop != null)
        ...
        {
            if (KTSettings.Instance is { } settings && settings.WorkshopEffectivnessEnabled)
