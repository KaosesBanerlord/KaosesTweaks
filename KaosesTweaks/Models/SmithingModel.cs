...
namespace KaosesTweaks.Models
{
    ...
    public class SmithingModel : DefaultSmithingModel
    {
        ...
        {
            if (!Factory.Settings.CraftingQualityTweaksEnabled)
            {
            ...
            {
                return Factory.Settings.CraftingQualityFineValue;
            }
            if (hero.GetPerkValue(DefaultPerks.Crafting.MasterSmith) && randomFloat < 0.35f)
            {
                return Factory.Settings.CraftingQualityMasterValue;
            }
            if (hero.GetPerkValue(DefaultPerks.Crafting.LegendarySmith))
            {
                ...
                {
                    return Factory.Settings.CraftingQualityLegendaryValue;
                }
            }
            return 0;
        }
        ...
        protected int GetModifiedFormulaInputCost(int originalCost)
        {
            ...
            if (Factory.Settings.RefiningFormulaTweaksEnabled)
            {
