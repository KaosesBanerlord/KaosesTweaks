...
namespace KaosesTweaks.Patches
{
    ...
    class KTBattleRewardsRenownGainPatch
    {
        private static bool Prefix(PartyBase party, float renownValueOfBattle, float contributionShare, ref ExplainedNumber __result)
        {
            if (MCMSettings.Instance is { } settings && settings.BattleRewardsRenownGainModifiers)
            {
                ...
                float modifiedRenownGain = originalRenownGain * settings.BattleRewardsRenownGainMultiplier;
    ...
    class KTBattleRewardsInfluenceGainPatch
    {
        private static bool Prefix(PartyBase party, float influenceValueOfBattle, float contributionShare, ref ExplainedNumber __result)
        {
            if (MCMSettings.Instance is { } settings && settings.BattleRewardsInfluenceGainModifiers)
            {
                ...
                float modifiedInfluenceGain = originalInfluenceGain * settings.BattleRewardsInfluenceGainMultiplier;
    ...
    class KTBattleRewardsMoraleGainPatch
    {
        private static bool Prefix(PartyBase party, float renownValueOfBattle, float contributionShare, ref ExplainedNumber __result)
        {
            if (MCMSettings.Instance is { } settings && settings.BattleRewardsMoraleGainModifiers)
            {
                ...
                float modifiedMoraleGain = originalMoraleGain * settings.BattleRewardsMoraleGainMultiplier;
    ...
    class KTBattleRewardsGoldLossPatch
    {
        ...
        {
            if (MCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardsGoldLossModifiers)
            {
                ...
                float modifiedGoldLoss = originalGoldLoss * settings.BattleRewardsGoldLossMultiplier;
