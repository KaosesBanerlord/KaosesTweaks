...
namespace KaosesTweaks.Patches
{
    ...
    public class DefaultPartyWageModelPatch
    {
        static void Postfix(MobileParty mobileParty, ref ExplainedNumber __result)
        {
            ...
            if (MCMSettings.Instance is { } settings2 && settings2.BalancingWagesTweaksEnabled && settings2.KingdomBalanceStrengthEnabled && mobileParty != null && mobileParty.LeaderHero != null && mobileParty.LeaderHero.Clan.Kingdom != null)
            {
                float num = 0f;
        ...
        static bool Prepare() => MCMSettings.Instance is { } settings && (settings.PartyWageTweaksEnabled || settings.KingdomBalanceStrengthEnabled);
    }
}
