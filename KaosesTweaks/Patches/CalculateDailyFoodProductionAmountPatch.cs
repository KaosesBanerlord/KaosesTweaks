...
namespace KaosesTweaks.Patches
{
    ...
    class CalculateDailyFoodProductionAmountPatch
    {
        static void Postfix(Village village, ref float __result)
        {
            ...
            if (village != null && Factory.Settings is { } settings2 && settings2.BalancingFoodTweakEnabled && settings2.KingdomBalanceStrengthEnabled && village.Settlement.OwnerClan.Kingdom != null)
            {
                float num = 0f;
        ...
        static bool Prepare() => Factory.Settings is { } settings && (settings.ProductionTweakEnabled || settings.KingdomBalanceStrengthEnabled);
    }
